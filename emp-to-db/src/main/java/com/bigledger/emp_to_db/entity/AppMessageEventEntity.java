...
public class AppMessageEventEntity {
	...
	private String messageStoreGuid;
	...
	public String getRemoteUserProfileJson() {
		return remoteUserProfileJson;
	}
	public String getMessageStoreGuid() {
		return messageStoreGuid;
	}
	...
	public void setRemoteUserProfileJson(String remoteUserProfileJson) {
		this.remoteUserProfileJson = remoteUserProfileJson;
	}
	public void setMessageStoreGuid(String messageStoreGuid) {
		this.messageStoreGuid = messageStoreGuid;
	}
